...
module.exports = {
  ...
  similarity: {
    levenshtein: (s1, s2, caseSensitive = true) => {
      const result = addon.calculateSimilarity(s1, s2, addon.AlgorithmType.LEVENSHTEIN, {
    ...
    damerauLevenshtein: (s1, s2, caseSensitive = true) => {
      const result = addon.calculateSimilarity(s1, s2, addon.AlgorithmType.DAMERAU_LEVENSHTEIN, {
        caseSensitivity: caseSensitive
          ? addon.CaseSensitivity.SENSITIVE
          : addon.CaseSensitivity.INSENSITIVE,
      });
    ...
    hamming: (s1, s2, caseSensitive = true) => {
      const result = addon.calculateSimilarity(s1, s2, addon.AlgorithmType.HAMMING, {
        caseSensitivity: caseSensitive
          ? addon.CaseSensitivity.SENSITIVE
          : addon.CaseSensitivity.INSENSITIVE,
      });
    ...
    jaro: (s1, s2, caseSensitive = true) => {
      const result = addon.calculateSimilarity(s1, s2, addon.AlgorithmType.JARO, {
        caseSensitivity: caseSensitive
          ? addon.CaseSensitivity.SENSITIVE
          : addon.CaseSensitivity.INSENSITIVE,
      });
    ...
    jaroWinkler: (s1, s2, caseSensitive = true, prefixWeight = 0.1) => {
      const result = addon.calculateSimilarity(s1, s2, addon.AlgorithmType.JARO_WINKLER, {
        caseSensitivity: caseSensitive
          ? addon.CaseSensitivity.SENSITIVE
          : addon.CaseSensitivity.INSENSITIVE,
    ...
    jaccard: (s1, s2, useWords = false, caseSensitive = true, ngramSize = 2) => {
      const result = addon.calculateSimilarity(s1, s2, addon.AlgorithmType.JACCARD, {
        preprocessing: useWords ? addon.PreprocessingMode.WORD : addon.PreprocessingMode.NGRAM,
        caseSensitivity: caseSensitive
          ? addon.CaseSensitivity.SENSITIVE
          : addon.CaseSensitivity.INSENSITIVE,
        ngramSize: ngramSize,
    ...
    dice: (s1, s2, useWords = false, caseSensitive = true, ngramSize = 2) => {
      const result = addon.calculateSimilarity(s1, s2, addon.AlgorithmType.SORENSEN_DICE, {
        preprocessing: useWords ? addon.PreprocessingMode.WORD : addon.PreprocessingMode.NGRAM,
        caseSensitivity: caseSensitive
          ? addon.CaseSensitivity.SENSITIVE
          : addon.CaseSensitivity.INSENSITIVE,
    ...
    cosine: (s1, s2, useWords = false, caseSensitive = true, ngramSize = 2) => {
      const result = addon.calculateSimilarity(s1, s2, addon.AlgorithmType.COSINE, {
        preprocessing: useWords ? addon.PreprocessingMode.WORD : addon.PreprocessingMode.NGRAM,
        caseSensitivity: caseSensitive
          ? addon.CaseSensitivity.SENSITIVE
          : addon.CaseSensitivity.INSENSITIVE,
    ...
    tversky: (s1, s2, alpha, beta, useWords = false, caseSensitive = true, ngramSize = 2) => {
      const result = addon.calculateSimilarity(s1, s2, addon.AlgorithmType.TVERSKY, {
        preprocessing: useWords ? addon.PreprocessingMode.WORD : addon.PreprocessingMode.NGRAM,
        caseSensitivity: caseSensitive
          ? addon.CaseSensitivity.SENSITIVE
          : addon.CaseSensitivity.INSENSITIVE,
  ...
  distance: {
    levenshtein: (s1, s2, caseSensitive = true) => {
      const result = addon.calculateDistance(s1, s2, addon.AlgorithmType.LEVENSHTEIN, {
        caseSensitivity: caseSensitive
          ? addon.CaseSensitivity.SENSITIVE
          : addon.CaseSensitivity.INSENSITIVE,
      });
    ...
    damerauLevenshtein: (s1, s2, caseSensitive = true) => {
      const result = addon.calculateDistance(s1, s2, addon.AlgorithmType.DAMERAU_LEVENSHTEIN, {
        caseSensitivity: caseSensitive
          ? addon.CaseSensitivity.SENSITIVE
          : addon.CaseSensitivity.INSENSITIVE,
      });
    ...
    hamming: (s1, s2, caseSensitive = true) => {
      const result = addon.calculateDistance(s1, s2, addon.AlgorithmType.HAMMING, {
        caseSensitivity: caseSensitive
          ? addon.CaseSensitivity.SENSITIVE
          : addon.CaseSensitivity.INSENSITIVE,
      });
    ...
    euclidean: (s1, s2, useWords = false, caseSensitive = true, ngramSize = 2) => {
      const result = addon.calculateDistance(s1, s2, addon.AlgorithmType.EUCLIDEAN, {
        preprocessing: useWords ? addon.PreprocessingMode.WORD : addon.PreprocessingMode.NGRAM,
        caseSensitivity: caseSensitive
          ? addon.CaseSensitivity.SENSITIVE
          : addon.CaseSensitivity.INSENSITIVE,
    ...
    manhattan: (s1, s2, useWords = false, caseSensitive = true, ngramSize = 2) => {
      const result = addon.calculateDistance(s1, s2, addon.AlgorithmType.MANHATTAN, {
        preprocessing: useWords ? addon.PreprocessingMode.WORD : addon.PreprocessingMode.NGRAM,
        caseSensitivity: caseSensitive
          ? addon.CaseSensitivity.SENSITIVE
          : addon.CaseSensitivity.INSENSITIVE,
    ...
    chebyshev: (s1, s2, useWords = false, caseSensitive = true, ngramSize = 2) => {
      const result = addon.calculateDistance(s1, s2, addon.AlgorithmType.CHEBYSHEV, {
        preprocessing: useWords ? addon.PreprocessingMode.WORD : addon.PreprocessingMode.NGRAM,
        caseSensitivity: caseSensitive
          ? addon.CaseSensitivity.SENSITIVE
          : addon.CaseSensitivity.INSENSITIVE,
  ...
  async: {
    ...
    damerauLevenshtein: (s1, s2, caseSensitive = true) =>
      addon.calculateSimilarityAsync(s1, s2, addon.AlgorithmType.DAMERAU_LEVENSHTEIN, {
        caseSensitivity: caseSensitive
          ? addon.CaseSensitivity.SENSITIVE
          : addon.CaseSensitivity.INSENSITIVE,
      }),
    ...
    dice: (s1, s2, useWords = false, caseSensitive = true, ngramSize = 2) =>
      addon.calculateSimilarityAsync(s1, s2, addon.AlgorithmType.SORENSEN_DICE, {
        preprocessing: useWords ? addon.PreprocessingMode.WORD : addon.PreprocessingMode.NGRAM,
        caseSensitivity: caseSensitive
          ? addon.CaseSensitivity.SENSITIVE
          : addon.CaseSensitivity.INSENSITIVE,
...
module.exports.ALGORITHM_PERFORMANCE = {
  LEVENSHTEIN: {
    ...
    recommendedFor: ['General text comparison', 'Spell checking', 'DNA sequences'],
  },
  DAMERAU_LEVENSHTEIN: {
    timeComplexity: 'O(m*n)',
  ...
  JARO_WINKLER: {
    ...
    isMetric: false,
    supportsEarlyTermination: false,
    recommendedFor: ['Names with common prefixes', 'Person matching', 'Address matching'],
  },
  JACCARD: {
    timeComplexity: 'O(m+n)',
    spaceComplexity: 'O(m+n)',
    ...
    isMetric: true,
    supportsEarlyTermination: false,
    recommendedFor: ['Document similarity', 'Set comparison', 'N-gram analysis'],
  },
  SORENSEN_DICE: {
    timeComplexity: 'O(m+n)',
    spaceComplexity: 'O(m+n)',
    ...
    isMetric: false,
    supportsEarlyTermination: false,
    recommendedFor: ['Document similarity', 'Biomedical texts', 'Overlap analysis'],
  },
  COSINE: {
    timeComplexity: 'O(m+n)',
    spaceComplexity: 'O(m+n)',
    ...
    isMetric: false,
    supportsEarlyTermination: false,
    recommendedFor: ['Document similarity', 'Vector comparison', 'Information retrieval'],
  },
  TVERSKY: {
    timeComplexity: 'O(m+n)',
    spaceComplexity: 'O(m+n)',
    ...
    isMetric: false,
    supportsEarlyTermination: false,
    recommendedFor: ['Asymmetric similarity', 'Prototype matching', 'Custom weighting'],
  },
};
